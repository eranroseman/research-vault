...
confirmed against `research/raw/2026-08-25-transcript-archive-manifest.md` before being marked closed rather
...
| 18 | Closed during this audit's own runtime | The reconstruction note (written earlier the same day) named transcript decay as an open gap. By the time this audit's migrate step reached it, `research/raw/2026-08-25-transcript-archive-manifest.md` already recorded 63 sessions, fixity-hashed, archived off-repo (snapshot `e45c976`) — landed same-day, independently. Residual: no named re-snapshot trigger, so today's coverage starts decaying again the moment a new session closes. |
