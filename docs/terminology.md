...
| Current term | Status |
|---|---|
| CLI `probe`, `import-note`, `staleness`, `backfill-selectors`, `verify`, `inbox`, `scaffold`, `doctor` (+ Plan D's `arm-publish`, `disarm-publish`, `mark-published`, `mark-corrected`, `mark-withdrawn`, `park`, `ack`, `finding`, `factcheck`, `trust-tier`, `archive-source`, `search-log`) | A/S — named by the verb decision tree below |
