...
`~/.claude/plugins/cache/superpowers-dev/superpowers/6.2.0/skills/`, confirmed via both
...
(`~/.agents/skills/writing-for-agents/SKILL.md`) supplies two more points once a check
