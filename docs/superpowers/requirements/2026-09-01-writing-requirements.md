...
*Source, withdrawn:* an earlier version cited FDA documentation levels, IEC 62304 classes A/B/C and IMDRF SaMD categories. **None was read and all three are withdrawn.** They are not needed for the principle, which 12207 supplies. What they would add is a named taxonomy, which 12207 deliberately does not carry — it delegates, and its own pointer is **ISO/IEC 15026-3:2011 "System integrity levels"** (NOTE 1 at 6.4.2.3(d.2); bibliography ref [22]), not 62304. **Open:** whether R3 should name a taxonomy at all, and if so whether 12207's pointer or the health-specific 62304 is the right one. Neither is reachable here.
