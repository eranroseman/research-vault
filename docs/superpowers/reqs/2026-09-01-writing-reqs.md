...
**Field order:** statement, *Fit*, *Why* (R44), *Floor* and *Version* on one line (R43, R45), *Source* (R11). **Eight requirements are hard floors** — R1, R8, R9, R11, R14, R20, R24, R42 — marked by the author on 2026-09-02 against the test *would I abandon the need rather than give this up?* The other thirty-one are marked no. `sourcing` S17 draws its screen from the eight and may use fewer, never more.
