...
| INCOSE GtWR V3.1                            | *INCOSE R25* on headings; the five set-level characteristics                                                                                                                                | R31, R35                                                    |
...
*Fit:* no sentence outside a requirement statement carries `must`, `shall` or `will`. **A requirement statement is the numbered line and its fit criterion**; everything else in the artifact is explanatory. Any obligation found in explanatory text is promoted to a numbered requirement before the review gate under R31.
...
- ~~**Is the tiering sourcing's or the requirement set's?**~~ **Answered 2026-09-02 from 29148 5.2.8: both, at different grains.** Whether a requirement is a hard floor is a requirement attribute (R43); which of those form the screen is the screener's call within them (`sourcing` S17). The standard is explicit that priority does not make a requirement optional.
