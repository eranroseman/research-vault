...
- [ ] **Step 2 (finding 12):** Scope AGENTS.md's "prefer the research-vault skills" line to the two model-invocable guards — seven of nine skills are user-gated by deliberate design; the line must not read as steering all nine. Do NOT flip any `disable-model-invocation` flag.
