...
| ------------------------------------------------------------------ | ------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian) | AgriciDaniel / AI Marketing Hub | MIT     | The compile step, installed whole and unmodified at pin `ad67087` and driven by a wrapper. No fork, no vendored prose — see [.out-of-scope/vendoring-compile-tool-prose.md](.out-of-scope/vendoring-compile-tool-prose.md). |
