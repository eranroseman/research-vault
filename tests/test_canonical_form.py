...
does the same, so no formatter speaks it. (Every STATIC template but one
goes through mdformat instead: their placeholder content carries no
list markup or wikilinks to mangle, so mdformat owns them. The one held
