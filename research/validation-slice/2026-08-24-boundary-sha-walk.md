...
`rglob("*.md")` across `_MDFORMAT_ROOTS = ("README.md", "AGENTS.md", "CONTEXT.md", "docs",
"skills")`. Across the merge:
...
- **§3.5** (33 deferred minors routed nowhere) — closed by `45c5e26`: 38 items enumerated into the
  polish-pass section of `research/validation-slice/2026-08-22-skills-layer-audit.md`. Verified
